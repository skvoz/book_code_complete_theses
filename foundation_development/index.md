...
###Выбор языка программирования( или средств предоставлямых комьюнити в рамках языка)
...
для выбора методики нужно ответит на [контольные вопросы](../control_list/design_methodology.md)
